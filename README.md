...
- 前端`React`和`Vue`偏向`React Hooks`，移动端（从[`anko`](https://github.com/Kotlin/anko)去世之后）首选`Flutter`，桌面就`Electron`吧（.net core开源之后可以考虑下[Avalonia](https://github.com/AvaloniaUI/Avalonia)）。
